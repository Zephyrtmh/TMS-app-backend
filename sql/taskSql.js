...
const getAllTasksByAppAcronym = "SELECT task_name, task_description, task_notes, task_id, task_plan, task_app_acronym, task_state, task_creator, task_owner, task_createdate , plans.plan_colour FROM tasks INNER JOIN plans ON tasks.task_plan = plans.plan_MVP_name WHERE task_app_acronym = ?;";
